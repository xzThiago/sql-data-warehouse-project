...
EDA (Exploratory Data Analysis) é o processo de explorar e compreender os dados 
antes de realizar análises mais avançadas ou construir modelos.

Neste projeto segui os seguintes passos de análise:
 - Entender a estrutura do banco
 - Explorar valores únicos
 - Analisar dimensões (clientes e produtos)
 - Entender o período dos dados
 - Calcular métricas principais
 - Comparar categorias
 - Identificar rankings
 - Encontrar padrões importantes
